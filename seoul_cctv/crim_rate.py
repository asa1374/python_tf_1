...
df_police.drop(columns=['강간 검거','강도 검거','살인 검거','절도 검거','폭력 검거'],inplace=True)
...
df_cctv_pop = pd.read_csv(ctx + 'df_cctv_pop'
                          ,encoding='utf-8'
                          ,index_col='구별')
...
df_police_norm['검거'] = df_police_norm['범죄'] /tmp_max *100
